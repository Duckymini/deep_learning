...
We train and evaluate on IHC while excluding all IHC training examples from the index. Macro F1 does not degrade meaningfully (-0.6 pp), confirming that the retriever generalises via semantic similarity rather than exploiting in-distribution shortcuts.
